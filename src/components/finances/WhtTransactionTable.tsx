        ...
        <table className="w-full">
          ...
          <tfoot className="bg-gray-50 border-t border-gray-200">
            <tr>
              ...
              <td className="px-4 py-3 text-sm text-gray-900 text-right font-medium">
                ฿{transactions.reduce((sum, t) => sum + (('invoiceAmount' in t) ? t.invoiceAmount : (t as WhtToSupplier).paymentAmount), 0).toLocaleString()}
              </td>
              <td className="px-4 py-3"></td>
              <td className="px-4 py-3 text-sm text-gray-900 text-right font-bold">
                ฿{transactions.reduce((sum, t) => sum + t.whtAmount, 0).toLocaleString()}
              </td>
              <td className="px-4 py-3"></td>
