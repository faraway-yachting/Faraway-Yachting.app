...
const basePath = '/accounting/accountant/expenses/purchase-inventory';
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-3 py-2 text-right text-xs font-medium text-gray-500 uppercase">Consumed</th>
              ...
              {purchase.line_items.map((li) => {
                ...
                return (
                  <tr key={li.id} className={isFullyConsumed ? 'bg-gray-50' : ''}>
                    ...
                    <td className="px-3 py-3 text-sm text-gray-600">{getProjectName(li.project_id)}</td>


                    <td className="px-3 py-3 text-sm text-gray-900 text-right">{li.quantity}</td>
        ...
        {purchase.line_items.some(
          ...
          <div className="mt-6 pt-4 border-t border-gray-200">
            <h3 className="text-sm font-semibold text-gray-700 mb-3">Consumption History</h3>
                  ...
                  >
                    <div>
                      ...
                      <span className="text-gray-500 ml-2">
                        {cr.quantity} {cr.unit || 'pcs'} consumed
                      </span>
                      <span className="text-gray-400 ml-2">{formatDate(cr.consumed_date)}</span>
                      <span className="text-gray-500 ml-2">→ {getProjectName(cr.project_id)}</span>
                      {cr.notes && (
      ...
      {consumeLineItem && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-white rounded-lg shadow-xl max-w-lg w-full mx-4 p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-1">Consume Inventory</h3>
            <p className="text-sm text-gray-500 mb-4">
              ...
              <div className="bg-gray-50 rounded-lg p-3">
                <div className="flex justify-between text-sm">
                  <span className="text-gray-500">
                    Cost ({consumeQty} x{' '}
                    {consumeLineItem.unit_price.toLocaleString('en-US', { minimumFractionDigits: 2 })}):
                  </span>
