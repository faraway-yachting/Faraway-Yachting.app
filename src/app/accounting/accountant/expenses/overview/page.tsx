  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        ...
        <Link
          href="/accounting/accountant/expenses/purchase-inventory"
          className="flex items-center gap-4 p-4 bg-white border border-gray-200 rounded-lg hover:border-[#5A7A8F] hover:shadow-sm transition-all group"
        >
        ...
        <Link
          href="/accounting/accountant/expenses/purchase-assets"
          className="flex items-center gap-4 p-4 bg-white border border-gray-200 rounded-lg hover:border-[#5A7A8F] hover:shadow-sm transition-all group"
        >
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  {overdueExpenses.length > 3 && (
                    <Link
                      href="/accounting/accountant/expenses/expense-records?payment=unpaid"
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  {pendingReceipts.length > 3 && (
                    <Link
                      href="/accounting/accountant/expenses/expense-records?receipt=pending"
      ...
      <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
          ...
          <Link
            href="/accounting/accountant/expenses/expense-records"
