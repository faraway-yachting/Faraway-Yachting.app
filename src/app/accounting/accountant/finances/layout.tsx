...
const financesTabs = [
  { label: 'Overview', href: '/accounting/accountant/finances/overview' },
  { label: 'Cash / Bank / e-Wallet', href: '/accounting/accountant/finances/cash-bank' },
  { label: 'Withheld Tax', href: '/accounting/accountant/finances/wht-from-customer' },
  { label: 'Withholding Tax', href: '/accounting/accountant/finances/wht-to-supplier' },
  { label: 'VAT', href: '/accounting/accountant/finances/vat' },
];
    ...
    <AppShell currentRole="accountant">
      ...
      <div className="bg-white border-b border-gray-200 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8 py-6">
        ...
        <p className="mt-1 text-sm text-gray-500">
          Track cash flow, account balances, withholding tax, and VAT
        </p>
      </div>
