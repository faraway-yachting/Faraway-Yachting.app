...
const financesTabs = [
  { label: 'Overview', href: '/accounting/manager/finances/overview' },
  { label: 'Cash / Bank / e-Wallet', href: '/accounting/manager/finances/cash-bank' },
  { label: 'Withheld Tax', href: '/accounting/manager/finances/wht-from-customer' },
  { label: 'Withholding Tax', href: '/accounting/manager/finances/wht-to-supplier' },
  { label: 'VAT', href: '/accounting/manager/finances/vat' },
];
