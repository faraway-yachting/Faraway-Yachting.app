...
const expensesTabs = [
  { label: 'Overview', href: '/accounting/manager/expenses/overview' },
  { label: 'Expense Record', href: '/accounting/manager/expenses/expense-records' },
  { label: 'Purchase Inventory', href: '/accounting/manager/expenses/purchase-inventory' },
  { label: 'Purchase Order (Asset)', href: '/accounting/manager/expenses/purchase-assets' },
  { label: 'Receive Credit Note', href: '/accounting/manager/expenses/credit-notes' },
  { label: 'Receive Debit Note', href: '/accounting/manager/expenses/debit-notes' },
];
