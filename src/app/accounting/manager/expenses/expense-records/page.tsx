...
import { formatCurrency, formatDate, isOverdue, getDaysUntilDue } from '@/lib/expenses/utils';
                      ...
                      <td className="px-4 py-3 whitespace-nowrap text-center">
                        <div className="flex items-center justify-center gap-1">
                          ...
                          {expense.status === 'draft' && (
                            <Link
                              href={`/accounting/manager/expenses/expense-records/${expense.id}?edit=true`}
                              className="p-1.5 text-gray-400 hover:text-[#5A7A8F] hover:bg-gray-100 rounded transition-colors"
                              title="Edit"
                            >
