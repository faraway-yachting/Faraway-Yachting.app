...
export const mockTopUps: PettyCashTopUp[] = [
  {
    ...
    topUpDate: '2025-01-02',
    reference: 'TRF-2501-001',
    notes: 'Monthly top-up for Ocean Star operations',
    status: 'completed',
  ...
  },
  {
    ...
    bankAccountId: 'bank-001',
    bankAccountName: 'Faraway Yachting - Operating Account',
    topUpDate: '2024-12-28',
    reference: 'TRF-2412-015',
    status: 'completed',
    approvedBy: 'Finance Manager',
  ...
  },
  {
    ...
    bankAccountName: 'Blue Horizon - Operating Account',
    topUpDate: '2024-12-30',
    reference: 'TRF-2412-020',
    notes: 'End of year top-up',
    status: 'completed',
    approvedBy: 'Finance Manager',
    approvedAt: '2024-12-30T11:00:00Z',
    completedBy: 'Finance Manager',
    completedAt: '2024-12-30T11:30:00Z',
    createdBy: 'user-acc-001',
    createdAt: '2024-12-30T10:00:00Z',
  },
  {
    id: 'pc-top-004',
    topUpNumber: 'PC-TOP-2501-0002',
    walletId: 'wallet-004',
    ...
    bankAccountId: 'bank-001',
    bankAccountName: 'Faraway Yachting - Operating Account',
    topUpDate: '2025-01-05',
    reference: 'TRF-2501-005',
    notes: 'Office petty cash replenishment',
    status: 'pending',
    createdBy: 'user-acc-001',
