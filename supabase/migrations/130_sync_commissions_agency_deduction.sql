-- Update commission sync RPC to deduct agency commission from charter fee
-- before calculating management fee and net income.
-- agency_commission_thb is the THB-converted agency commission amount.
...
BEGIN
  ...
  WITH new_owned AS (
    ...
    SELECT
      ...
      ROUND((COALESCE(b.charter_fee, b.total_price, 0) - COALESCE(b.agency_commission_thb, 0)) * COALESCE(p.management_fee_percentage, 0) / 100, 2),
  ...
  --     management_fee = charter_cost, net_income = (charter_fee - agency_commission) - charter_cost
